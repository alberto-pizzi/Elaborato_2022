...
public:
    Bow(bool equipped, const sf::Texture &bowTexture, const sf::Texture &arrowTexture,
        int totBullets = -999, int damage = 3, sf::Time shotDelay = sf::seconds(3), float reloadTime = 1,
        int magazineCapacity = 3, int remainingBullets = 3); //bow has infinite bullets (-999)
